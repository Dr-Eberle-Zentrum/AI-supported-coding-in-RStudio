...
Use automated style checking tools like [`lintr`](https://lintr.r-lib.org/) to enforce standards:
...
Enforce standards before code is committed via [pre-commit hooks](https://stefaniemolin.com/articles/devx/pre-commit/setup-guide/)
